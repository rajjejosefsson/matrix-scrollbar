import t from "inferno";
import { findDOMNode as e } from "inferno-compat";
function r(t, e, r) {
  return (
    e in t
...
class n extends t.Component {
  constructor(...t) {
    super(...t),
      r(this, "_scrollbar", void 0),
      r(this, "_scrollViewport", void 0);
  }
  get ownerWindow() {
    return this._scrollbar.scrollViewport.ownerDocument.defaultView;
  }
...
r(n, "defaultProps", { autoHideThumb: !0, minThumbHeight: 30 });
export { n as MatrixScrollbar };
