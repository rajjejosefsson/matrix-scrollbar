!(function(t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ? e(exports, require("inferno"), require("inferno-compat"))
    : "function" == typeof define && define.amd
    ? define(["exports", "inferno", "inferno-compat"], e)
    : e(((t = t || self).MatrixScrollbar = {}), t.Inferno, t.infernoCompat);
})(this, function(t, e, r) {
  "use strict";
  function i(t, e, r) {
    return (
  ...
  var o,
    l = (function(t, e) {
      ...
      t.exports = class {
        ...
        _hideThumb() {
          this._scrollbar.thumb.style.display = this.autoHideThumb
            ? "none"
            : "";
        }
        _showThumb() {
  ...
  class n extends e.Component {
    constructor(...t) {
      super(...t),
        i(this, "_scrollbar", void 0),
        i(this, "_scrollViewport", void 0);
    }
    get ownerWindow() {
      return this._scrollbar.scrollViewport.ownerDocument.defaultView;
    }
  ...
  i(n, "defaultProps", { autoHideThumb: !0, minThumbHeight: 30 }),
    (t.MatrixScrollbar = n),
